...
// Asset URLs and download instructions
...
- Coin: https://poly.pizza/m/7IrL01B97W (click Download, select GLB format)
- Star Coin: https://poly.pizza/m/n5nJIQAozN (click Download, select GLB format)
- Mushroom: https://poly.pizza/m/A2rwQyfqYG (click Download, select GLB format)
- Pipe: https://poly.pizza/m/f1A1MuUQfC3 (click Download, select GLB format)
